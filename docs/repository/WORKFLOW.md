# Master Repo repository workflow
...
- For engineering constraints, see `docs/system/AGENT_CONTEXT.md`.
...
For MR-3 and subsequent process work, read `docs/system/PROJECT.md` and keep it plus
`docs/repository/CHANGELOG.md` current. Assess Task Tracker impact on every process/contract
